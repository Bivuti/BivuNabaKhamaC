...
BivuNabaKhamaC is the first Chakma font developed specifically for preparing textbooks in the Chakma language. This font was newly updated on $$\color{red}{**30 June 2026**.}$$  With this updated version, it is now possible to write all types of signs and symbols required for the Chakma language. The details are provided below:
